...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_task__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/task */ \"./src/modules/task.js\");\n/* harmony import */ var _modules_deleteItem__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/deleteItem */ \"./src/modules/deleteItem.js\");\n/* harmony import */ var _modules_display__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/display */ \"./src/modules/display.js\");\n\r\n\r\n\r\n\r\n\r\nconst clearbtn = document.getElementById('clear');\r\nclearbtn.addEventListener('click',() => {\r\n    _modules_display__WEBPACK_IMPORTED_MODULE_3__.todo.clearCompleted();\r\n    (0,_modules_display__WEBPACK_IMPORTED_MODULE_3__.display)();\r\n});\r\nconst form = document.querySelector('form');\r\nform.addEventListener('submit', () => {\r\n    const list = document.querySelector('.form');\r\n    const item = list.value;\r\n    if (item !== '') {\r\n      _modules_display__WEBPACK_IMPORTED_MODULE_3__.todo.addList(description);\r\n      (0,_modules_display__WEBPACK_IMPORTED_MODULE_3__.display)();\r\n      list.value = '';\r\n    }\r\n});\r\n\r\ndocument.addEventListener('click', (e) => {\r\n  if (e.target.className === 'fa fa-trash') {\r\n    (0,_modules_deleteItem__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(e.target.id);\r\n  }\r\n});\r\n(0,_modules_task__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\n\n//# sourceURL=webpack://to-do-list/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ List)\n/* harmony export */ });\nclass List {\r\n    todes = []\r\n\r\n    addList(description) {\r\n        const list = {\r\n            description,\r\n            completed: false,\r\n            index: this.todes.length + 1,\r\n        }\r\n        this.todes.push(list)\r\n        this.saveList()\r\n    }\r\n\r\n    completedTodo(s, index) {\r\n        this.todos[index - 1].completed = s;\r\n        this.saveList();\r\n    }\r\n\r\n    clearCompleted() {\r\n        this.todos = this.todos.filter(\r\n          (item) => item.completed === false,\r\n        );\r\n        this.upToDate();\r\n        this.saveList();\r\n    }\r\n\r\n    clearAll() {\r\n        this.todos.splice(0, this.todos.length);\r\n        this.saveList();\r\n    }\r\n\r\n    saveList() {\r\n        const store = JSON.stringify(this.todos);\r\n        localStorage.setItem('store', store);\r\n    }\r\n\r\n    getsaveList() {\r\n        this.todos = JSON.parse(\r\n          localStorage.getItem('store'),\r\n        );\r\n    }\r\n    itemRemove(i) {\r\n        this.todos.splice(i - 1, 1);\r\n        this.upToDate();\r\n        this.saveList();\r\n    }\r\n    upToDate() {\r\n        this.todos.map((items) => {\r\n          items.index = this.todos.indexOf(items) + 1;\r\n          return items;\r\n        });\r\n    }\r\n    edit(paragraph, i) {\r\n        this.todos[i - 1].description = paragraph.textContent;\r\n        this.saveList();\r\n    }\r\n}\n\n//# sourceURL=webpack://to-do-list/./src/modules/list.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _display_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./display.js */ \"./src/modules/display.js\");\n\r\n\r\nconst dispays = () => {\r\n  if (localStorage.getItem('store')) {\r\n    _display_js__WEBPACK_IMPORTED_MODULE_0__.todo.getsaveList();\r\n    (0,_display_js__WEBPACK_IMPORTED_MODULE_0__.display)();\r\n  } else {\r\n    (0,_display_js__WEBPACK_IMPORTED_MODULE_0__.display)();\r\n  }\r\n};\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (dispays);\n\n//# sourceURL=webpack://to-do-list/./src/modules/task.js?");
